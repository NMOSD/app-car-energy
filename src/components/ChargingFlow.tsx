...
import { formatDateEU, parseEUDate, todayDate, formatCurrency, calculateKWh } from '../utils'
...
interface Props {
  ...
  onStartCharge: (stationId: string, startPercent: number, date: string) => void
...
export function ChargingFlow({
  ...
  const handleStart = () => {
    ...
    onStartCharge(stationId, startPercent, isoDate)
